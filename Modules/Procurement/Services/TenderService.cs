...
public class TenderService : ITenderService
{
    ...
    public async Task<TenderDto> OpenBidsAsync(int tenderId, int actorUserId)
    {
        ...
        // Вскрывать можно с дня окончания срока, а не со следующего: срок — это
        // дата, к её концу приём закрыт, и комиссия вскрывает заявки в назначенный
        // день. Прежнее «<=» блокировало вскрытие в сам день срока — конкурс,
        // объявленный и закрытый одним днём, вскрыть было нельзя вовсе.
