...
public class Supplier : IAuditableEntity
{
    ...
    /// <summary>
    /// Нерезидент Кыргызской Республики.
    ///
    /// С таким поставщиком договор заключается независимо от суммы закупки
    /// (п. 10.4 Положения): освобождение от договора по сумме на него не
    /// распространяется.
    /// </summary>
