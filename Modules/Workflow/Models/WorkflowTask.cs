...
public class WorkflowTask
{
    ...
    /// <summary>
    /// Кто делегировал задачу текущему исполнителю (СК-3). Пусто — задача не
    /// делегировалась. Замещение (GEN-14) сюда не пишется: оно временное и снимается
    /// само, а делегирование — разовая передача одной задачи по решению исполнителя.
    /// Нужно, чтобы в реестре у делегата стояла пометка «от кого», а в истории было
    /// видно, что визу поставил не изначально назначенный.
    /// </summary>
