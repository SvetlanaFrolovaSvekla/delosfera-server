...
public class DocumentConfiguration : IEntityTypeConfiguration<Document>
{
    public void Configure(EntityTypeBuilder<Document> builder)
    {
        ...
        // Оптимистичная блокировка (GEN-05). Карточку правят несколько человек — автор,
        // делопроизводитель, согласующий; без неё последнее сохранение молча затирало бы
        // чужие правки, и узнать об этом можно было бы только из аудита задним числом.
        //
        // Токеном служит системная колонка Postgres xmin: она есть у каждой строки,
        // и заводить отдельное поле с ручным инкрементом незачем.
