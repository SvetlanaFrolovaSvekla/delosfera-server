...
/// ответственные сотрудники СП за актуализацию ВНД и ежемесячная сводка им 1-го числа.
///
...
public class ActualizationNotificationsController : ControllerBase
{
    ...
    public ActualizationNotificationsController(
        IActualizationNotificationService service, ILanguageResolver languageResolver)
    {
        _service = service;
